...
{		
	...
	{		
		this.INSTRUCTION_COUNT = 300;	
		this.SYMBOL_TABLE_SIZE_BYTES = 0x01000;
	
		this.Instructions = new Array();	/* array of 300 instructions */
	...
	// this.ENCODED_PLC_DATA_SIZE = 21400;	/* SIZE IN BYTES OF ENCODED PLC_DATA STRUCTURE MAKE SURE THIS IS KEPT UPTO DATA IS DATA STRUCT SIZE CHANGES! = PLC_DATA struct size X 2 */
	this.ENCODED_PLC_DATA_SIZE = 25000;	/* SIZE IN BYTES OF ENCODED PLC_DATA STRUCTURE MAKE SURE THIS IS KEPT UPTO DATA IS DATA STRUCT SIZE CHANGES! = PLC_DATA struct size X 2 */
	...
	this._NON_IOID = 0;
	this._NON_OPCODE = 0;
	this._Opcodes = new Array("", "START", "TSTEQ", "TSTNE", "TSTGT", "TSTLT", "TSTGE", "TSTLE", "SET", "ADD", "SUB", "DIV", "MUL", "DEC", "INC", "AND", "OR", "XOR", "BNZ", "BZ", "CNZ", "CZ", "CALLSUB", "GOTO", "DELAY", "NOP",
							"RET", "EMAIL", "X10", "PRINT", "END"); /* opcode id's start at 0x01 hence the null at index 0 */
	this._IOIdentifiers = new Array("NON_ID", "OP1", "OP2", "OP3", "OP4", "OP5", "OP6", "OP7", "OP8", "IP1", "IP2", "IP3", "IP4", "IP5", "IP6", "IP7", "IP8", "AIP1", "AIP2", "AIP3", "AIP4", "AIP5", "AIP6", "AIP7","AIP8","T1", "T2", "T3", "T4", "T5",
								   "T6", "T7", "T8", "H1", "EM1", "EM2", "EM3", "EM4", "EM5", "EM6", "EM7", "EM8", "CD", "CT", "CDW", "CH", "CM", "CS", "CDAY", "CMONTH", "CYEAR", "VAR1", "VAR2", "VAR3", "VAR4", "VAR5", "VAR6", "VAR7", "VAR8",
								   "RAM1", "RAM2", "RAM3", "RAM4", "RAM5", "RAM6", "RAM7", "RAM8", "TS1", "TS2", "TS3", "TS4", "TS5", "TS6", "TS7", "TS8");	/* io id's start at 0x01 hence the null at index 0 */
	...
	*/
	...
	{	
		...
		{
			throw("Invalid decode data string length");
		}
