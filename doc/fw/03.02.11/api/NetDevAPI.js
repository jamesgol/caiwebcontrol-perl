...
function GeneralCfg()
{
	...
	this._DATA_STRUCT_SIZE = 22;	 //size of NVM_GENERAL_CONFIG structure 
	...
	this.setUROM1 = function(urom1)
	{
		if(urom1 == NaN)
		{
			urom1.trim();
			urom1 = parseInt(urom1);
		}
		this._urom1 = urom1;
	}
	
	this.getUROM1 = function()
	{
		return this._urom1;
	}

	this.setUROM2 = function(urom2)
	{
		if(urom2 == NaN)
		{
			urom2.trim();
			urom2 = parseInt(urom2);
		}
		this._urom2 = urom2;
	}
	this.getUROM2 = function()
	{
		return this._urom2;
	}

	this.setUROM3 = function(urom3)
	{
		if(urom3 == NaN)
		{
			urom3.trim();
			urom3 = parseInt(urom3);
		}
		this._urom3 = urom3;
	}
	this.getUROM3 = function()
	{
		return this._urom3;
	}

	this.setUROM4 = function(urom4)
	{
		if(urom4 == NaN)
		{
			urom4.trim();
			urom4 = parseInt(urom4);
		}
		this._urom4 = urom4;
	}
	this.getUROM4 = function()
	{
		return this._urom4;
	}
	...
	this.encode = function()
	{
		...
		str += Encoding.encodeInt32(this._urom1);
		str += Encoding.encodeInt32(this._urom2);
		str += Encoding.encodeInt32(this._urom3);
		str += Encoding.encodeInt32(this._urom4);
	...
	this.decode = function(str)
	{
		...
		idx+=8;
		this._urom1 = Encoding.decodeInt32(str.substr(idx, 8));
		idx+=8;
		this._urom2 = Encoding.decodeInt32(str.substr(idx, 8));
		idx+=8;
		this._urom3 = Encoding.decodeInt32(str.substr(idx, 8));
		idx+=8;
		this._urom4 = Encoding.decodeInt32(str.substr(idx, 8));
		idx+=8;
